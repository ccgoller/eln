...
| # | Guide | Description |
|---|-------|-------------|
| 1 | [Create a GitHub Organization](instructor-setup/01-create-organization.md) | The shared home for all student notebooks |
| 2 | [Create a Template Repository](instructor-setup/02-template-repository.md) | The starting point each student notebook is built from |
