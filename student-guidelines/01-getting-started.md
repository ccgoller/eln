...
3. Press (Command + S on Mac) or (Ctrl + S on Windows) to save all changes. This will save changes in VS Code; however, extra steps are needed to commit and push the changes so it shows in GitHub. 
